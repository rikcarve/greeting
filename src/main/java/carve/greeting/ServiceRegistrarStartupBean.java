...
public class ServiceRegistrarStartupBean {
    ...
    public void register(Timer timer) {
        try {
            int port = (int) ManagementFactory.getPlatformMBeanServer().getAttribute(new ObjectName("jboss.as:socket-binding-group=standard-sockets,socket-binding=http"), "boundPort");
